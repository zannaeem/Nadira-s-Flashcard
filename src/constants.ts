...
export const FLASHCARD_DATA: Chapter[] = [
  {
    ...
    cards: [
      ...
      },
      {
        ...
        jawapan: "Meningkatkan jualan dan keuntungan: Sebuah organisasi akan berusaha meningkatkan jualan dan keuntungan yang lebih tinggi dengan meninggikan daya saing domestik.\nMeluaskan Operasi: Kebergantungan kepada pasaran yang sedia ada menyebabkan syarikat meluaskan operasi ke negara lain."
      },
      {
        id: 7,
      ...
      },
      {
        ...
        jawapan: "MITI: Merangka dasar dan strategi pembangunan perindustrian; Menggubal dan menggalakkan hubungan perdagangan dua hala dan pelbagai hala serta kerjasama perdagangan serantau; Merancang dan menggalak pembangunan prestasi eksport Malaysia di pasaran antarabangsa.\nMATRADE: Memastikan negara mendapat faedah yang maksimum daripada institusi pembuatan; Memperkenalkan, mewujudkan dan membangunkan perdagangan luar negara dengan penekanan kepada eksport barangan siap dan separuh siap."
      },
      {
        id: 9,
